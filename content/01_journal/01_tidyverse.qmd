...
bikes_tbl <- readxl::read_excel(path = "content/00_data/01_bike_sales/01_raw_data/bikes.xlsx")

bikeshops_tbl <- read_excel(path = "content/00_raw_data/01_bike_sales/01_raw_data/bikeshops.xlsx")

orderlines_tbl <- read_excel(path = "content/00_raw_data/01_bike_sales/01_raw_data/orderlines.xlsx")
